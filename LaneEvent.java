...
public class LaneEvent {
	...
	Bowler bowler;
	int[][] cumulScore;
	HashMap<Object, int[]> score;
	int index;
	int frameNum;
	int[] curScores;
	boolean mechProb;
	
	public LaneEvent(Party pty, int theIndex, Bowler theBowler, int[][] theCumulScore, HashMap<Object, int[]> theScore, int theFrameNum, int[] theCurScores, int theBall, boolean mechProblem) {
		p = pty;
		index = theIndex;
		bowler = theBowler;
	...
	public HashMap<Object, int[]> getScore( ) {
		return score;
	}
